...
class ImePayController extends Controller
{
    ...
    {
        self::$apiuser = config('imePay.apiuser');
        self::$password = config('imePay.password');
        self::$module = config('imePay.module');
        self::$merchantcode = config('imePay.merchant_code');
    }
    ...
    public static function index($amount, $refId)
    {
        ...
        return view('frontend.imePay',compact('token_response','merch_code'));
    }
    ...
    public function paymentSuccess(Request $request){
        if($request){
            ...
            $request->session()->put('imePayResponse',$response);
             return redirect()->route('imepay.success');
    ...
    {
 $response  = session()->get('imePayResponse');

       return view('frontend.imePaySuccess',compact('response'));
    }
