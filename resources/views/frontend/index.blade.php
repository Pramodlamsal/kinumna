                ...
                <div class="col-lg-3 position-static order-2 order-lg-0">
                    <div class="category-sidebar">
                        ...
                        <ul class="categories no-scrollbar">
                            ...
                            @foreach (\App\Category::all()->take(13) as $key => $category)
                                @php
                                    $brands = array();
                                @endphp
                    ...
                    <div class="home-slide">
                        <div class="home-slide">
                            <div class="slick-carousel" data-slick-arrows="true" data-slick-dots="true" data-slick-autoplay="true">
                                @foreach (\App\Slider::where('published', 1)->orderBy('display_order','asc')->get() as $key => $slider)
                                    <div>
        ...
        <div class="container">
            <div class="px-2 py-4 p-md-4 bg-white shadow-sm">
                <div class="section-title-1 clearfix ">
                    ...
                    <span class="badge badge-danger" style="margin-left: 5px;"><b>{{__('Hot')}}</b></span>
                </div>
                                            ...
                                            <div class="p-md-3 p-2">
                                                <div class="price-box">
                                                 @if(home_base_price($product->id) != home_discounted_base_price($product->id))
                                                        ...
                                                        @endif
                                                        <br><span class="product-price strong-600">{{ home_discounted_base_price($product->id) }}</span>
                                                    </div>
               ...
               <div class="container">
                   <div class="px-2 py-4 p-md-4 bg-white shadow-sm">
                       <div class="section-title-1 clearfix">
                           ...
                           <ul class="inline-links float-right">
                               <li><a href="{{ route('customer.products') }}" class="active" style="background: #EB2329; border-color: #EB2329;">{{__('View More')}}</a></li>
                           </ul>
                       </div>
            ...
            <div class="row gutters-10">
                <div class="col-lg-6">
                    <div class="section-title-1 clearfix">
                        ...
                        <ul class="float-right inline-links">
                            <li>
                                <a href="{{ route('categories.all') }}" class="active" style="background: #EB2329; border-color: #EB2329;">{{__('View All Catogories')}}</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="section-title-1 clearfix">
                        ...
                        <ul class="float-right inline-links">
                            <li>
                                <a href="{{ route('brands.all') }}" class="active" style="background: #EB2329; border-color: #EB2329;">{{__('View All Brands')}}</a>
                            </li>
                        </ul>
                    </div>
                    <div class="row gutters-5">
