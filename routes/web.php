...
Route::group(['middleware' => ['checkout']], function(){
	...
	Route::get('/shipping-price/district/{district}', 'CheckoutController@getShippingPriceBasedOnDistrict')->name('get.shipping.price');
});
...
//Stripe END
    ...
    //imePaySection
        ...
        Route::get('/payment/ime/{amt}/{refid}', 'ImePayController@index');
    Route::post('/payment/confirm', 'ImePayController@confirmPayment');
    Route::get('/imepay/confirm','ImePayController@paymentSuccess');
    Route::get('/imePay/success','ImePayController@confirmSuccess')->name('imepay.success');
    Route::get('imePay/cancel','ImePayController@confirmCancel')->name('imepay.error');
    Route::get('/imepay/cancel','ImePayController@cancel');
